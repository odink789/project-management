...
//membuat type data sendiri untuk listOrder
// di ListOrder kita menyimpan uuid array
// alasan menggunakan custom type:
// 1. gorm/postgres tidak meng-handle array uuid secara langsung
// 2. dengan custom type kita bisa menentukan cara parsing ke db
// package models
